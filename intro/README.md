...
Αν δεν διαθέτετε τα απαραίτητα δικαιώματα ή το υπολογιστικό σας σύστημα είναι χαμηλών επιδόσεων μπορείτε να συνεχίσετε με χρήση του Google Colab. Παρέχουμε [ένα σχετικά σύντομο (και όχι πλήρη) οδηγό χρήσης του Google Colab](ColabIntro.md).
